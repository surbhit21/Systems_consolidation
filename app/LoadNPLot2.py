...
def PlotAll(input_data_folder="./data/CNT_fast_drift_with_limited1_IP_lowI", op_plot_folder="./plots/CNT_fast_drift_with_limited1_IP_lowI"):
    ...
    plot_engram_size(last_activity_all, threshold=threshold, title = "Engram size (HPC)",fname="{}/engram_size_HPC.svg".format(op_plot_folder))
    plot_engram_size(last_activity_all_ctx, threshold=threshold,title = "Engram size (CTX)", fname="{}/engram_size_CTX.svg".format(op_plot_folder))
    ...
    plot_activity_n_excitability_time([EX_history_all[-1].T,EX_history_all_ctx[-1].T,input_history[-1].T],
                        titles=['Neuronal Excitability (HPC)',
                                    ...
                                    'Input Activity'],
                        seqA=seqA,
                        fname="{}/Excitability.svg".format(op_plot_folder),
    ...
    mean_corr, std_corr, per_sim_corr, idx = plot_mean_std_corr_over_time(
        ...
        include_ref_bar=True,
        title="Cell population \n activity correlation",
        fname="{}/off1_vs_others_mean_std.svg".format(op_plot_folder),
        cmap = "Oranges",
        marker = "^"
    )
    ...
    mean_corr, std_corr, per_sim_corr, idx = plot_mean_std_corr_over_time(
        ...
        include_ref_bar=True,
        title="Cell population \n activity correlation",
        fname="{}/off1_vs_others_mean_std_ctx.svg".format(op_plot_folder),
        cmap = "Greens"
    )
    ...
    mean_corr, std_corr, per_sim_corr, idx = plot_mean_std_corr_over_time(
        ...
        include_ref_bar=True,
        title="Cell population \n activity correlation",
        fname="{}/recall_vs_others_mean_std.svg".format(op_plot_folder),
        cmap = "Oranges",
        marker = "^"
    ...
    mean_corr, std_corr, per_sim_corr, idx = plot_mean_std_corr_over_time(
        ...
        include_ref_bar=True,
        title="Cell population \n activity correlation",
        fname="{}/recall_vs_others_mean_std_ctx.svg".format(op_plot_folder),
        cmap = "Greens",
    ...
    #     title="Cell population \n activity correlation",
    #     fname="{}/encoding_vs_offline_mean_std.svg".format(op_plot_folder),
    #     cmap = "Oranges",
    #     marker = "^"
    # )
    # mean_corr, std_corr, per_sim_corr, idx = plot_mean_std_corr_over_time(
    ...
    #     include_ref_bar=False,
    #     title="Cell population \n activity correlation",
    #     fname="{}/encoding_vs_offline_mean_std_ctx.svg".format(op_plot_folder),
    #     cmap = "Greens"
    # )
    ...
    # #     include_ref_bar=False,
    # #     title="Cell population \n activity correlation",
    # #     fname="{}/recall_vs_offline_mean_std.svg".format(op_plot_folder),
    # #     cmap = "Oranges",
    # #     marker = "^"
    ...
    # #     include_ref_bar=False,
    # #     title="Cell population \n activity correlation",
    # #     fname="{}/recall_vs_offline_mean_std_ctx.svg".format(op_plot_folder),
    # #     cmap = "Greens"
    ...
    # fig.tight_layout()
    # plt.savefig("{}/overlap_frac_first_mean_sem.svg".format(op_plot_folder))
    # plt.show()
    ...
    #     fname="{}/first_activity_vs_counts_concat.svg".format(op_plot_folder)
    # )
    # print(r1)
    ...
    #     include_ref_in_count=True,
    #     sem_mode='pooled',
    #     fname="{}/first_act_vs_sessions_pooled.svg".format(op_plot_folder)
    # )
